...
// Trang danh sách "Thu hồi & hoàn kho" — nối API thật GET /api/v1/inventory/return-reports (backend
// đang chạy: D:\sep490-backend-api, KHÔNG PHẢI D:\bnwems-backend-api — xem cảnh báo đầu
// docs/more-require.md). Không có nút "Tạo phiếu": POST cùng endpoint chỉ role LEADER gọi được (403
// với Manager/Admin) — Leader Staff ghi nhận phiếu qua ứng dụng di động tại hiện trường, đúng nguyên
// tắc CLAUDE.md ("Leader Staff ghi nhận trước, Manager chỉ xác nhận trên web"). Web chỉ xem danh sách +
// vào chi tiết để xác nhận (PUT .../confirm, chỉ role MANAGER).
