...
import { Box, Check, CheckCircle2, ChevronDown, ChevronLeft, Copy, Download, FileSignature, FileText, Mail, MapPin, Package, Pencil, Phone, Plus, Printer, Trash2, X } from 'lucide-react';
