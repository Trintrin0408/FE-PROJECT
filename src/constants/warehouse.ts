...
// (tọa độ trung tâm Quận 1, TP.HCM) để demo tính năng "~X km từ kho" ở form tạo đơn — KHÔNG dùng để tính
// phụ phí vận chuyển thật cho tới khi được thay bằng tọa độ kho thật.
export const WAREHOUSE_COORDINATES: LatLng = { lat: 10.7769, lng: 106.7009 };
